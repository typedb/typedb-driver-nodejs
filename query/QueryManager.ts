...
export class QueryManager {
    ...
    public match(query: string, options?: GraknOptions): Stream<ConceptMap> {
        ...
        return this.iterateQuery(matchQuery, options ? options : new GraknOptions(), (res: Transaction.Res) => res.getQueryRes().getMatchRes().getAnswerList().map((map) => ConceptMap.of(map)));
    }
    ...
    public insert(query: string, options?: GraknOptions): Stream<ConceptMap> {
        ...
        return this.iterateQuery(insertQuery, options ? options : new GraknOptions(), (res: Transaction.Res) => res.getQueryRes().getInsertRes().getAnswerList().map((map) => ConceptMap.of(map)));
    }
