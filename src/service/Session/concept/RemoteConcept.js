...
module.exports = {
    Concept: class Concept {
        constructor(id, txService, baseType) {
            this.id = id;
    ...
    SchemaConcept: class SchemaConcept {
        label(label) {
    ...
    Type: class Type extends SchemaConcept {
        isAbstract(bool) {
    ...
    AttributeType: class extends Type {
    ...
    EntityType: class extends Type {
        create() { return this.txService.addEntity(this.id); }
    },

    Relation: class extends Thing {
    ...
    RelationType: class extends Type {
    ...
    Role: class extends SchemaConcept {
    ...
    Rule: class extends SchemaConcept {
